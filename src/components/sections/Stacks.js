        ...
        <>
            ...
            <div className='stackList' >
                <ul>
                    ...
                    <li>
                        <img src={express} />Express
                        <span className="ejs" > EJS |</span>
                    ...
                    <li>
                        ...
                        <span className="socket" > Socket.io |</span>
                    ...
                    <li>
                        <img src={sql} />SQL |
                        <span className="postgre" > PostgreSQL |</span>
                        <span className="sequelize" > Sequelize </span>

                    </li>
                    <li>
                        <img src={mongo} />MongoDB |
                        <span className="mongoose" > mongoose |</span><span className="atlas"> mongoDB Atlas</span>
                    </li>
                </ul>
            </div>
